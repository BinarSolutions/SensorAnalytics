...
public class MyActivity extends ActionBarActivity  implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mTextView3.setTextColor(Color.parseColor("#ffffffff"));
    ...
    if (checkInternetConnection()){
        ...
        if (isWiFi){
            ...
            mTextView1.setTextColor(Color.parseColor("#ff00ff00"));
        }
        if (!isWiFi) {
            mTextView1.setText(R.string.network_status_cell);
            mTextView1.setTextColor(Color.parseColor("#ffffff00"));
        }
    }
    if(!checkInternetConnection()){
        mTextView1.setText(R.string.network_status_no);
        mTextView2.setText("N/A");
        mTextView1.setTextColor(Color.parseColor("#ffff0000"));
        mTextView1.setTextColor(Color.parseColor("#ffff0000"));
    }
    ...
    public void start (View view) {
        final EditText editText1 = (EditText) findViewById(R.id.edit_message);
        final String message1 = editText1.getText().toString();
            ...
            if (checkInternetConnection()) {
                ...
                if (isWiFi) {
                    ...
                    if (TextUtils.isEmpty(message1)) {
                        editText1.setError("Please fill in!");
                        return;
                    }
                    else {
                    ...
                    if (TextUtils.isEmpty(name)) {
                        editText2.setError("Please fill in!");
                        return;
                    }
                    else {
                        editText2.setError(null);
                    }
                    if (!TextUtils.isEmpty(message1) && !TextUtils.isEmpty(name)) {
                        if(Integer.parseInt(message1) < 5) {
                            editText1.setError("5 or more seconds!");
                            ...
                            if (selected != 0) {
                                if (!wrongSensor()) {
                                    ...
                                    mTextView1.setText(R.string.network_status_wifi);
                                    mTextView1.setTextColor(Color.parseColor("#ff00ff00"));
                                    mTextView2.setTextColor(Color.parseColor("#ff00ff00"));
                            ...
                            builder.setMessage("Period cannot be set to less than 5 seconds. Choose another value.");
                            builder.setPositiveButton("OK, I'll do it", new DialogInterface.OnClickListener() {
                                @Override
                    ...
                    if (selected == 0) {
                        ...
                        new AlertDialog.Builder(this)
                                ...
                                .setPositiveButton("Whatever.", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                ...
                mTextView2.setText("N/A");
                mTextView1.setTextColor(Color.parseColor("#ffff0000"));
                mTextView2.setTextColor(Color.parseColor("#ffff0000"));
            }
    ...
    public void stop (View view) {
        ...
        mTextView3.setTextColor(Color.parseColor("#ffff5400"));
        Context context = getApplicationContext();
        CharSequence text = "Job stopped!";
        int duration = Toast.LENGTH_SHORT;
        Toast toast = Toast.makeText(context, text, duration);
        toast.show();
        mTextView2.setTextColor(Color.parseColor("#ffff9400"));
